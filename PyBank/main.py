...
with open(output_path,"w",newline = '') as output_file:
    ...
    output_file.write (".........................")
    output_file.write ("Total number of months "+ str(len(months)))#Q1
    output_file.write ("Total profit and loss "+ str(sum(revenue)))#Q2
    output_file.write ("Average changes "+ str(averagechange))#Q3
    output_file.write ("Greatest Increase in " + (months[revenuechange.index(max(revenuechange)) +1] + " " + "(" + str(greatestincrease) +")"))#Q4
    output_file.write ("Greatest Decrease in " + (months[revenuechange.index(min(revenuechange)) +1] + " " + "(" + str(greatestdecrease)+")")) #Q5
